...
const generateFishes = (numFish) => {
    ...
    for (let i = 0; i < numFish; ++i) {
        ...
        let fish = generateFish(x, y, url, -1 * randomDecimal(1, 6), randomDecimal(0.2, 0.25));
        fishes.push(fish);
        ...
        fish = generateFish(x, y, url, randomDecimal(1, 6), randomDecimal(0.2, 0.25));
        fishes.push(fish);
    }
    return fishes;
};
...
//as an argument
const fishList = generateFishes(12);
